...
where each pair of hexade cimal digits represents the intensity of the red, green, or blue component
of the pixel.
*/
...
var palette = []color.Color{color.White, color.RGBA{0x15, 0xEE, 0xDD, 0x01}}

const (
	backgroundColorIndex = 0 // first color in palette
	lineColorIndex       = 1 // next color in palette
)
